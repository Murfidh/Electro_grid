...
public class User {
	...
	/*Insert user*/
	public String insertUser(String name, String address, String NIC,String category,String phone,String connection,String Status) {
		 ...
		 try
		 {
				 ...
				 String query = " insert into user (`cid`,`name`,`address`,`NIC`,`category`,`phone`,`connection`,`Status`)"
				 + " values (?, ?, ?, ?,?,?,?,?)";
		...
		public String readUser(){
		 ...
		 try
		 {
			 ...
			 "<th>NIC</th><th>Consumer Category</th><th>Phone</th><th>connection</th><th>Status</th>" +
		...
		/*update User*/
		public String updateUser(String cid, String name, String address,String NIC, String category,String phone,String connection,String Status)
		{
			 String output = "";
			 try {
			 ...
			 if (con == null){
				 ...
				 // create a prepared statement
				 String query = "UPDATE `user` SET `name`=?,`address`=?,`NIC`=?,`category`=?,`phone`=?,`connection`=?,`Status`=? WHERE `cid`=?";
				 PreparedStatement preparedStmt = con.prepareStatement(query);
				 // binding values
