...
public class Customer {
	//A common method to connect to the DB
		...
		public String insertcustomermanagement(String fullname, String telephoneNumber, String address, String District, String meterBoxId, String readingCurrent, String nic )
		 {
		 String output = "";
		 try
		 {
		 ...
		 String query = " insert into customermanagement (`customerId`,`fullname`,`telephoneNumber`,`address`,`District`, `meterBoxId`, `readingCurrent`, `nic`)" + " values (?, ?, ?, ?, ?,?,?,?)";
		 ...
		 preparedStmt.setString(6, meterBoxId);
		...
		public String readItems()
		 ...
		 String meterBoxId = rs.getString("meterBoxId");
		...
		public String updatecustomermanagement(String customerId, String fullname, String telephoneNumber, String address, String District, String meterBoxId, String readingCurrent, String nic )
		 ...
		 // create a prepared statement
		 String query = "UPDATE customermanagement SET fullname=?,telephoneNumber=?, address=?, District=?, meterBoxId=?, readingCurrent=?, nic=? WHERE customerId=?";
		 PreparedStatement preparedStmt = con.prepareStatement(query);
		 // binding values
		 ...
		 preparedStmt.setString(5, meterBoxId);
