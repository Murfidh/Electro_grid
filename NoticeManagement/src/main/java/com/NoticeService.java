...
//-----------------------------------------------------------------------------	
	...
	public String insertNotice(@FormParam("Heading") String Heading,
	 @FormParam("Description") String Description,
	 @FormParam("Branch") String Branch){
		
	 String output = noticeObj.insertNotice(Heading, Description, Branch);
	 return output;
	}
...
//-------------------------------------------------------------------------------
	...
	//Convert the input string to a JSON object
	 ...
	 String Heading = noticeObject.get("Heading").getAsString();
	 String Description = noticeObject.get("Description").getAsString();
	 String Branch = noticeObject.get("Branch").getAsString();
	 String output = noticeObj.updateNotice(ID, Heading, Description, Branch);
	 return output;
	}
