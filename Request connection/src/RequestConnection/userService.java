...
public class userService {
	...
	public String insertUser(@FormParam("name") String name,
			...
			String output = userObj.insertUser(name,address,NIC,category,phone,connection,Status);
			return output;
	}
	...
	//Convert the input string to a JSON object
			...
			//Read the values from the JSON object
			 ...
			 String output = userObj.updateUser(cid,name,address,NIC,category,phone,connection,Status);
