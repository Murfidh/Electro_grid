...
public class CustomerService {
	...
	public String insertcustomermanagement(@FormParam("fullname") String fullname,
	 @FormParam("telephoneNumber") String telephoneNumber,
	 @FormParam("address") String address,
	 @FormParam("District") String District,
	@FormParam("meterBoxId") String meterBoxId,
    @FormParam("readingCurrent") String readingCurrent,
     @FormParam("nic") String nic)
	{
	 String output = Obj.insertcustomermanagement(fullname, telephoneNumber, address, District, meterBoxId, readingCurrent, nic);
	return output;
	}
	...
	//Read the values from the JSON object
	 ...
	 String meterBoxId = Object.get("meterBoxId").getAsString();
	 String readingCurrent = Object.get("readingCurrent").getAsString();
	 String nic = Object.get("nic").getAsString();
	 String output = Obj.updatecustomermanagement(customerId, fullname, telephoneNumber, address, District, meterBoxId, readingCurrent, nic);
	return output;
	}
